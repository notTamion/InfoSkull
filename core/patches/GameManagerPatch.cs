...
namespace InfoSkull.core.patches;
...
public class GameManagerPatch
{
	...
	[HarmonyPatch("Pause")]
	[HarmonyPostfix]
	public static void postfixPause()
	{
		...
		if (reportBug && !GameObject.Find("Adjust UI"))
		{
			...
			button.onClick.AddListener(() => core.InfoSkull.openAdjustUI());
			button.enabled = true;
	...
	[HarmonyPostfix]
	public static void postfixUnPause()
	{
